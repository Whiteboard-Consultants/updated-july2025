/*
  # Sample Data Population for LMS

  1. Categories
    - Test Preparation, Language Skills, Professional Skills, Academic Preparation
  
  2. Users (Sample profiles - in production these would be created through auth)
    - Admin, Instructors, Students with proper roles
  
  3. Courses
    - TOEFL, IELTS, Public Speaking, Spoken English, GRE courses
  
  4. Lessons
    - Sample lessons for each course with proper structure
  
  5. Enrollments & Progress
    - Student enrollments and learning progress tracking
  
  6. Assignments & Submissions
    - Sample assignments with student submissions and grades
  
  7. Communication
    - Messages, notifications, reviews
  
  8. Events & Certificates
    - Calendar events and completion certificates
*/
...
-- First, create auth users (these would normally be created through Supabase Auth signup)
-- Note: In production, users sign up through the auth system first
INSERT INTO auth.users (
  ...
  (
    ...
    'admin@whiteboardconsultant.com',
  ...
  (
    ...
    '00000000-0000-0000-0000-000000000000',
    'instructor@whiteboardconsultant.com',
    crypt('demo123', gen_salt('bf')),
    now(),
    now(),
    now(),
  ...
  (
    ...
    '00000000-0000-0000-0000-000000000000',
    'student@whiteboardconsultant.com',
    crypt('demo123', gen_salt('bf')),
    now(),
    now(),
    now(),
  ...
  (
    ...
    '00000000-0000-0000-0000-000000000000',
    'instructor2@whiteboardconsultant.com',
    crypt('demo123', gen_salt('bf')),
    now(),
    now(),
    now(),
  ...
  (
    ...
    '00000000-0000-0000-0000-000000000000',
    'student2@whiteboardconsultant.com',
    crypt('demo123', gen_salt('bf')),
    now(),
    now(),
    now(),
  ...
  (
    ...
    '00000000-0000-0000-0000-000000000000',
    'student3@whiteboardconsultant.com',
    crypt('demo123', gen_salt('bf')),
    now(),
    now(),
    now(),
...
-- Now insert the corresponding user profiles
INSERT INTO users (id, auth_id, email, first_name, last_name, role, avatar_url, bio) VALUES
  ('650e8400-e29b-41d4-a716-446655440010', '650e8400-e29b-41d4-a716-446655440010', 'admin@whiteboardconsultant.com', 'Sarah', 'Mitchell', 'admin', 'https://images.pexels.com/photos/3777943/pexels-photo-3777943.jpeg', 'Senior Business Consultant with 15+ years of experience in strategic planning and organizational development.'),
  ('650e8400-e29b-41d4-a716-446655440011', '650e8400-e29b-41d4-a716-446655440011', 'instructor@whiteboardconsultant.com', 'David', 'Chen', 'instructor', 'https://images.pexels.com/photos/3777931/pexels-photo-3777931.jpeg', 'Expert facilitator specializing in team dynamics and collaborative problem-solving with TOEFL/IELTS certification.'),
  ('650e8400-e29b-41d4-a716-446655440012', '650e8400-e29b-41d4-a716-446655440012', 'student@whiteboardconsultant.com', 'Priya', 'Sharma', 'student', 'https://images.pexels.com/photos/3777936/pexels-photo-3777936.jpeg', 'Aspiring international student preparing for TOEFL and university applications.'),
  ('650e8400-e29b-41d4-a716-446655440013', '650e8400-e29b-41d4-a716-446655440013', 'instructor2@whiteboardconsultant.com', 'Maria', 'Rodriguez', 'instructor', 'https://images.pexels.com/photos/3777943/pexels-photo-3777943.jpeg', 'Innovation specialist with expertise in design thinking and creative methodologies.'),
  ('650e8400-e29b-41d4-a716-446655440014', '650e8400-e29b-41d4-a716-446655440014', 'student2@whiteboardconsultant.com', 'Rahul', 'Kumar', 'student', 'https://images.pexels.com/photos/3777931/pexels-photo-3777931.jpeg', 'Engineering student preparing for GRE and graduate school applications.'),
  ('650e8400-e29b-41d4-a716-446655440015', '650e8400-e29b-41d4-a716-446655440015', 'student3@whiteboardconsultant.com', 'Arjun', 'Patel', 'student', 'https://images.pexels.com/photos/3777936/pexels-photo-3777936.jpeg', 'Business professional looking to improve public speaking and communication skills.')
ON CONFLICT (email) DO NOTHING;

-- Insert sample courses (now that users exist)
